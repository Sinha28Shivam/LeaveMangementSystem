		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#leavemgmtsyst-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"leavemgmtsyst-display": {
								"semanticObject": "leavemgmtsyst",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=leavemgmtsyst",
									"url": sap.ui.require.toUrl("leavemgmtsyst")
								}
							}
						}
					}
